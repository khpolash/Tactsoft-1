    ...
    public partial class creatDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllowanceSettings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AllowensName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Allowenss", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "AllowensDetailss",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SalarySetupId = table.Column<long>(type: "bigint", nullable: false),
                    Amount = table.Column<double>(type: "float", nullable: false),
                    AllowensId = table.Column<long>(type: "bigint", nullable: false),
                    CreatedBy = table.Column<long>(type: "bigint", nullable: false),
                    CreatedDateUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedBy = table.Column<long>(type: "bigint", nullable: true),
                    UpdatedDateUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllowensDetailss", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AllowensDetailss_Allowenss_AllowensId",
                        column: x => x.AllowensId,
                        principalTable: "Allowenss",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AttandanceDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EmployeeId = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "AllowanceType", "CreatedBy", "CreatedDateUtc", "UpdatedBy", "UpdatedDateUtc", "Value", "valuePercetize" },
                values: new object[] { 1L, 0, 0L, new DateTimeOffset(new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 0, 0, 0)), null, null, 30000.0, "Good" });

            migrationBuilder.InsertData(
                table: "Allowenss",
                columns: new[] { "Id", "AllowensName", "Comment", "CreatedBy", "CreatedDateUtc", "UpdatedBy", "UpdatedDateUtc" },
                values: new object[] { 1L, "Notice", "Salary Encrement 10% ", 0L, new DateTimeOffset(new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 0, 0, 0)), null, null });
            ...
            migrationBuilder.InsertData(
                table: "SalaryType",
                columns: new[] { "Id", "CreatedBy", "CreatedDateUtc", "SalaryTypeName", "UpdatedBy", "UpdatedDateUtc" },
                values: new object[] { 1L, 0L, new DateTimeOffset(new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 0, 0, 0)), "House Rent", null, null });
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "BloodGroupId", "BrancehId", "CityId", "CompanyId", "CountryId", "CreatedBy", "CreatedDateUtc", "DateOfBirth", "FristName", "GenderId", "JoiningDate", "LastName", "MaritialStatusId", "MiddleName", "NID", "Nationalaty", "Password", "Picture", "ProjectId", "ReligionId", "StateId", "UpdatedBy", "UpdatedDateUtc", "UserName" },
            ...
            migrationBuilder.InsertData(
                table: "Attandances",
                columns: new[] { "Id", "AttandanceDate", "CreatedBy", "CreatedDateUtc", "EmployeeId", "Present", "Remarks", "UpdatedBy", "UpdatedDateUtc" },
                values: new object[] { 1L, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0L, new DateTimeOffset(new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 0, 0, 0)), 1L, 0, "Good", null, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, 1L, 1L, 0L, new DateTimeOffset(new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 0, 0, 0)), new DateTime(2023, 3, 7, 0, 0, 0, 0, DateTimeKind.Local), 1L, "Admin", new DateTime(2023, 3, 7, 10, 0, 0, 0, DateTimeKind.Unspecified), 5.0, new DateTime(2023, 3, 7, 10, 0, 0, 0, DateTimeKind.Unspecified), 5.0, null, null });
            ...
            migrationBuilder.InsertData(
                table: "SalarySetups",
                columns: new[] { "Id", "Basic", "CreatedBy", "CreatedDateUtc", "EmployeeId", "UpdatedBy", "UpdatedDateUtc" },
                values: new object[] { 1L, 80000.0, 0L, new DateTimeOffset(new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 0, 0, 0)), 1L, null, null });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "AllowensId", "Amount", "CreatedBy", "CreatedDateUtc", "SalarySetupId", "UpdatedBy", "UpdatedDateUtc" },
                values: new object[] { 1L, 1L, 10000.0, 0L, new DateTimeOffset(new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 0, 0, 0)), 1L, null, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AllowensDetailss_AllowensId",
                table: "AllowensDetailss",
                column: "AllowensId");

            migrationBuilder.CreateIndex(
                name: "IX_AllowensDetailss_SalarySetupId",
                table: "AllowensDetailss",
                column: "SalarySetupId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AllowensDetailss_SalarySetups_SalarySetupId",
                table: "AllowensDetailss",
                column: "SalarySetupId",
                principalTable: "SalarySetups",
                principalColumn: "Id",
                onDelete: ReferentialAction.Restrict);
