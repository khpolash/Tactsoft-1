...
namespace Tactsoft.Data.Migrations
{
    ...
    [Migration("20230322075442_AllowanceSetup")]
    partial class AllowanceSetup
    {
            ...
            modelBuilder.Entity("Tactsoft.Core.Entities.Attendance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EmployeeId = 1L,
                            EntryType = "Admin",
                            Intime = new DateTime(2023, 3, 22, 10, 0, 0, 0, DateTimeKind.Unspecified),
                            IntimeNumber = 5.0,
                            OutTime = new DateTime(2023, 3, 22, 10, 0, 0, 0, DateTimeKind.Unspecified),
                            OutTimeNumber = 5.0
                        });
                });
